        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-[var(--muted)] text-sm max-w-xs leading-relaxed">
              Writer, Software Engineer, Expert, Entrepreneur, Creator. Building
              at the intersection of AI, design, and storytelling.
            </p>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-[var(--muted)] font-medium">
            ...
            <Link
              href="/admin/login"
              className="hover:text-[var(--accent)] transition-colors py-2"
            >
              Admin
            </Link>
            <Link
